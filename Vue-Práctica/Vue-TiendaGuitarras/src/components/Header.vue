...
//Obtiene el prop guitarra enviado por app.vue
const props = defineProps({
    carrito: {
        type: Array,
        required: true
    },
    //Prop de guitarra promocional
    guitarra: {
        type: Object,
        required: true
    },
                                        ...
                                        <tr v-for="guitarra in carrito" :key="guitarra.id">
                                            ...
                                            <td class="flex align-items-start gap-4">
                                                <button type="button" class="btn btn-dark"
                                                    @click="$emit('decrementarCantidad', guitarra)">
                                                    -
                                                </button>
                                                {{ guitarra.cantidad }}
                                                <button type="button" class="btn btn-dark"
                                                    @click="$emit('incrementarCantidad', guitarra)">
                                                    +
                                                </button>
                                            </td>
                                            <td>
                                                <button class="btn btn-danger" type="button"  @click="$emit('eliminarProducto', guitarra)">
                                                    X
                                                </button>
                                            </td>
                                        </tr>
            ...
            <div class="row mt-5">
                <div class="col-md-6 text-center text-md-start pt-5">
                    ...
                    <button type="button" class="btn fs-4 bg-primary text-white py-2 px-5"
                        @click="$emit('agregar-carrito', guitarra)">Agregar al Carrito
                    </button>
                </div>
            </div>
        </div>
